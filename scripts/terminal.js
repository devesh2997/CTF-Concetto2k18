...
var Terminal = (function () {
	...
	promptInput = function (terminalObj, message, PROMPT_TYPE, callback) {
		...
		terminalObj._inputLine.textContent = message
		terminalObj._input.style.display = 'inline'
		terminalObj.html.appendChild(inputField)
		fireCursorInterval(inputField, terminalObj)

		//if (message.length) terminalObj.printAndStay(PROMPT_TYPE === PROMPT_CONFIRM ? message + ' (y/n)' : message)
	...
	var TerminalConstructor = function (id) {
		...
		this.printAndStay = function (message) {
			var newLine = document.createElement('div')
			newLine.textContent = message
		...
		this.getTeamName = function(callback){
			promptTeamName(this, callback)
		}
